...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            rooms::commands::matrix_get_room_preview,
            rooms::commands::matrix_get_space_child_ids,
            rooms::commands::matrix_get_chat_navigation,
            rooms::commands::matrix_get_chat_navigation_with_unjoined,
            rooms::commands::matrix_join_room,
            rooms::commands::matrix_leave_room,
            rooms::commands::matrix_leave_rooms,
